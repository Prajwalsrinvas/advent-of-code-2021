<article class="day-desc"><h2><a href="https://adventofcode.com/2021/day/4">--- Day 4: Giant Squid ---</a></h2><p>You're already almost 1.5km (almost a mile) below the surface of the ocean, already so deep that you can't see any sunlight. What you <em>can</em> see, however, is a giant squid that has attached itself to the outside of your submarine.</p>
