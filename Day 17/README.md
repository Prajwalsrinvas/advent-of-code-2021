<article class="day-desc"><h2><a href="https://adventofcode.com/2021/day/17">--- Day 17: Trick Shot ---</a></h2><p>You finally decode the Elves' message. <code><span title="Maybe you need to turn the message 90 degrees counterclockwise?">HI</span></code>, the message says. You continue searching for the sleigh keys.</p>
